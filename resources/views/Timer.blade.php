<font size="6">
<p align="right">
           <button style="align:right" type="button" onClick="Stopwatch.start();">STR</button>
		    <button style="align:right"  type="button" onClick="Stopwatch.stop();">STP</button>
			<button  style="align:right" type="button" onClick="Stopwatch.restart();">RST</button>
			<button  style="align:right" type="button" onClick="Stopwatch.lap();">LAP</button>

			<!--<a href="#iid" class="button" onClick="Stopwatch.start();">STR</a>
			<a href="#iid" class="button" onClick="Stopwatch.stop();">STP</a>
			<a href="#iid" class="button" onClick="Stopwatch.restart();">RST</a>-->
		<div class="stopwatch"></div>
		<table class="results"></table></font>
		<script>
